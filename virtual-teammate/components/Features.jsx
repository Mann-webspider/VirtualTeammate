...
function Features() {
    const Testi = (props) => {
        return(
            <div>
                <h3 className='font-extrabold text-3xl'>{props.num} {props.thou?"K":""}<sup className='text-[#9ecfb2]'>+</sup></h3>
                <h4 className='font-bold text-xl'>{props.head}</h4>
  ...
  return (
    <div className='w-screen h-fit bg-[#f2f2f2]   flex justify-center items-center text-center pb-20'>
        ...
        <h2 className='text-4xl font-bold lg:text-5xl w-22 mx-8 mt-20'>Features And Benefits</h2>
        <p className='my-8  text-[#8a8a8b] font-medium w-2.5/3 lg:w-2/3 text-lg'>Lorem ipsum dolor sit amet consectetur adipisicing Lorem ipsum dolor, sit amet consectetur adipisicing elit. Ut placeat in facilis corrupti, et amet?</p>
