...
function Hero() {
    ...
    // AOS.refresh();
    return (
        <div className='scroll-smooth  h-fit md:w-screen md:h-fit  lg:h-screen bg-gradient-to-br from-[#aacfb9] via-[#f2f2f2] to-[#f2f2f2] flex flex-col-reverse justify-around lg:items-center   lg:flex-row lg:px-8 px-4'>
            <div data-aos="fade-right" className="left max-w-xl lg:w-2/4 flex  h-96 lg:h-full lg:pr-4 flex-col  lg:justify-center justify-around md:max-w-screen-md md:flex md:justify-start     md:items-start md:px-16">
            ...
            <div data-aos="fade-left"className="right h-min max-w-xl lg:w-1/2 md:max-w-screen-md md:flex md:justify-center md:items-center md:py-8 py-16">
