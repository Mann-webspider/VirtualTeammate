...
function Hero() {
    return (
        <div className=' h-screen md:w-screen md:h-fit  lg:h-screen bg-gradient-to-br from-[#aacfb9] via-white to-white flex flex-col-reverse justify-around lg:items-center   lg:flex-row lg:px-8 px-4'>
            <div className="left max-w-xl lg:w-2/4 flex    h-96 lg:h-full lg:pr-4 flex-col  lg:justify-center justify-around md:max-w-screen-md md:flex md:justify-start     md:items-start md:px-16">
                ...
                <Link href={'#'}><button className=' bg-[#aacfb9] py-2 rounded-full font-bold flex items-center justify-between lg:font-bold lg:text-xl pl-8 '>Get start -- Now <span className='ml-4 mr-2'><HiArrowSmRight className='h-12 w-12 bg-black text-white rounded-full p-2 '/></span> 
                    </button></Link>
                </div>
            </div>
