...
function Hero() {
    return (
        <div className=' h-screen bg-gradient-to-br from-[#aacfb9] to-white flex flex-wrap-reverse justify-around lg:items-center  lg:flex-row lg:px-8 px-4'>
            ...
            <div className="right bg-blue-500 max-w-xl lg:w-1/2  relative  ">
                <div className='bg-yellow-500 lg:absolute  h-fit  w-fit lg:w-full lg:h-full  ' >

                    <div className='mask1 '>
                        <Image src={heroImg} className='hero  object-cover
                         rounded-[3.5rem] z-0 lg:w-[40rem] lg:h-[40rem]  ' />
                    </div>
